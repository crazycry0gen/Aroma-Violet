...
namespace Aroma_Violet.Controllers
{
    public class EmailTemplatesController : Controller
    {
        ...
        public void SendReport(int clientId)
        {
            CreateSnapshotAndMailFromView(clientId, string.Format("Downline Statement {0}", clientId), "DownlineStatement");
        }

        public void CreateSnapshotAndMailFromView(int clientId, string subject, string relativePath)
        {
            ...
            using (var writer = new StringWriter())
            {
                ...
                CreateSnapshotAndMail(clientId, subject, content, 3);
            }
        }
        ...
        public void CreateSnapshotAndMail(int clientId, string subject, string html, int savedHtmlTypeId)
        {
            ...
            //var setting = Generic.GetSetting(db,"From Email Address")

            // David Harington <david@novusfragrances.co.za>
            //var mailClient = new MassComm.MassEmail("c.hattingh@hotmail.com", "smtp.live.com", "N0k1a!@#$&", 587, "c.hattingh@hotmail.com");
            var mailClient = new MassComm.MassEmail("info@novusfragrances.co.za", "smtp.redcactus.co.za", "Novus36939$$NI", 587, "info@novusfragrances.co.za");
            var msg = new MassComm.EmailLayout() {EmailTo=address.ContactName, Subject = subject , Body = this.MyStyle() + html };
...
tr.fintot {
        ...
        table, th, td {
            ...
            table.pickingList, th.pickingList, td.pickingList {
